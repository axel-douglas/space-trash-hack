...
class GoldFeatureRow(BaseModel):
    ...
    regolith_d50_um: float = Field(ge=0.0)
    regolith_spectral_slope_1um: float = Field(ge=-1.0)
    regolith_mass_loss_400c: float = Field(ge=0.0, le=1.0)
    regolith_h2o_peak_c: float = Field(ge=0.0)
