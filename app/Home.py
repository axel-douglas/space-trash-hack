...
# ⚠️ PRIMER comando de Streamlit en esta página:
st.set_page_config(
...
# recién ahora importamos cosas que podrían llamar a Streamlit por dentro
...
st.markdown(
    "**Objetivo:** convertir basura inorgánica en productos útiles, minimizando agua/energía/tiempo "
    "de tripulación y evitando PFAS/microplásticos/incineración."
)
...
with col1:
    ...
    card("1) Inventario", "Cargá/edita residuos disponibles (tabla NASA simplificada).")
    card("2) Objetivo", "Elegí producto y prioridades (agua/energía/tiempo/seguridad).")
    card("3) Generador", "Recetas (mezclas) + proceso sugerido con predicciones.")
    card("4) Resultados", "Pareto, Sankey, checklist y métricas de impacto.")
